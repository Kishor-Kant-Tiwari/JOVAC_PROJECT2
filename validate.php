...
while(!feof($file))
{
  ...
  if ($str_arr[1]==$psw and $str_arr[2]==$email)
  {
		...
		echo "<h1><center>You are Authorized User</h1></center>"."<br>";
		echo "<h3>Your Name is</h3>".$str_arr[0]."<br>";
		echo "<h3>Your University RollNo. is</h3>".$str_arr[3]."<br>";
		echo "<h3>Your Course Name is</h3>".$str_arr[5]."<br>";
		echo "<h3>Your Course Application Number is</h3>".$str_arr[4]."<br>";
		echo "<h3>Your Course Starting Date is</h3>".$str_arr[6]."<br>";
		if ($str_arr[5]=="Cloud Computing") {
			echo "<p align=center><strong>Please Click here to Download Cloud Computing Syllabus <a href=abc.php?file=CC>Syllabus</strong></p></a><br>";
		}
		elseif ($str_arr[5]=="Machine Learning") {
			echo "<p align=center><strong>Please Click here to Download Machine Learning Syllabus <a href=abc.php?file=ML>Syllabus</strong></p></a><br>";
		}
		elseif ($str_arr[5]=="Cyber Security") {
			echo "<p align=center><strong>Please Click here to Download Cyber Security Syllabus <a href=abc.php?file=CS>Syllabus</strong></p></a><br>";
		}
		elseif ($str_arr[5]=="Joy of Programming using Python") {
			echo "<p align=center><strong>Please Click here to Download Joy of Programming using Python Syllabus <a href=abc.php?file=PY>Syllabus</strong></p></a><br>";
		}
		elseif ($str_arr[5]=="Fundamentals of Image Processing") {
			echo "<p align=center><strong>Please Click here to Download Fundamentals of Image Processing Syllabus <a href=abc.php?file=IP>Syllabus</strong></p></a><br>";
		}
